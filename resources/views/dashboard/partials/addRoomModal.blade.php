            ...
            <div class="modal-body" style="text-align: left;">
                <form action="/dashboard/rooms" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('building_id') is-invalid @enderror" name="building_id"
                    ...
                    <div class="mb-3">
                        ...
                        <input autocomplete="off" type="text"
                            ...
                            placeholder="Contoh: R 4-1, BR 2-3, Aula Utama" required value="{{ old('name') }}">
                        @error('name')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input autocomplete="off" type="text"
                            ...
                            placeholder="Contoh: R-4-1, BR-2-3, Aula-Utama" required value="{{ old('code') }}">
                        @error('code')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
...
<script>
    $(document).ready(function() {
        // Clear form ketika modal ditutup
