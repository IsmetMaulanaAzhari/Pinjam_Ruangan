...
<<<<<<< HEAD
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="border: none; border-radius: 15px; box-shadow: 0 10px 40px rgba(0,0,0,0.15);">
            <div class="modal-header" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%); color: white; border-radius: 15px 15px 0 0; padding: 20px 30px; border: none;">
...
<<<<<<< HEAD
                    ...
                    <div class="modal-footer" style="border: none; padding: 0; padding-top: 20px;">
                        ...
                        <button type="submit" class="btn btn-success"
                            style="border-radius: 8px; padding: 10px 24px; font-weight: 500; background: #28a745; border: none;">
                            <i class="bi bi-check-circle me-1"></i>Tambah Mahasiswa
                        </button>
                    </div>
                </form>
            </div>
