            ...
            <div class="row align-items-center">
                <div class="col-xl-5 offset-xl-7 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                    <div class="hero-content">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".4s">Selamat datang di Website Peminjaman Ruang Terbaik di Universitas Teknokrat Indonesia. Temukan, pesan, dan gunakan ruang kampus dengan mudah</p>
                        <div class="hero-btns">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-7 col-md-10 mx-auto">
                    <div class="section-title text-center">
                        ...
                        <p class="wow fadeInUp" data-wow-delay=".4s">Tata Cara Penggunaan Sistem Peminjaman Ruangan<br> Universitas Teknokrat Indonesia</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-skill wow fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="skill-content">
                            <h4>Login</h4>
                            <p>Silahkan login terlebih dahulu sesuai dengan username yang telah disediakan oleh admin</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-4 col-md-6">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-skill wow fadeInUp" data-wow-delay=".6s">
                        <div class="skill-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-snapchat" viewBox="0 0 16 16">
